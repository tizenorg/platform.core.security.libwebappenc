...
#define APP_DEK_KEK_PUB_KEY_PATH "/usr/share/wae/app_dek/WAE_APPDEK_KEK_PublicKey.pem"
#define APP_DEK_KEK_PRI_KEY_PATH "/usr/share/wae/app_dek/WAE_APPDEK_KEK_PrivateKey.pem"
...
int _get_app_dek_kek_from_key_manager(unsigned char** ppDekKek, int* kekLen);
