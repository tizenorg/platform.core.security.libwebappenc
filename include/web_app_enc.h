...
typedef enum
{
    ...
    WAE_ERROR_NO_KEY                   = - 0x03, /**< No internal key */
    WAE_ERROR_KEY_MANAGER              = - 0x04, /**< key-manager internal error */
    WAE_ERROR_CRYPTO                   = - 0x05, /**< failed in crypto operation */
    WAE_ERROR_MEMORY                   = - 0x06, /**< failed to allocate memory */
    WAE_ERROR_FILE                     = - 0x07, /**< failed to read or write a file*/
    WAE_ERROR_UNKNOWN                  = - 0x08 ,/** < Unknown error */
} wae_error_e;
